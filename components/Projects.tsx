          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {project.tech.map((t: string, i: number) => (
                <span
                  key={i}
                  className="text-[10px] font-orbitron tracking-tight text-neon-purple bg-neon-purple/10 px-2 py-1 rounded-sm border border-neon-purple/30 uppercase"
                >
                  {t}
                </span>
              ))}
            ...
            <div className="flex justify-between items-center border-t border-white/10 pt-4 mt-auto">
              <a
                ...
                className="text-gray-400 hover:text-white hover:drop-shadow-[0_0_8px_#ffffff] transition-all flex items-center gap-2 text-xs font-orbitron uppercase tracking-widest"
              >
              ...
              <a
                ...
                rel="noreferrer"
                onClick={(e) => e.stopPropagation()}
                className="text-neon-cyan text-xs font-orbitron hover:shadow-neon-cyan px-4 py-1.5 border border-neon-cyan/50 rounded-sm hover:bg-neon-cyan/10 transition-all flex items-center gap-2 uppercase tracking-widest"
              >
